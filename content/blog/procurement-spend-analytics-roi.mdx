...
<FlowChart title="The Spend Analytics to ROI Pipeline" steps='[{"label":"Analyze Current Spend","detail":"Categorize 12 months of purchasing data"},{"label":"Quantify Inefficiencies","detail":"Emergency premiums, single-source overpayment, maverick spend"},{"label":"Map to Automation","detail":"Match waste categories to software capabilities"},{"label":"Calculate Net Savings","detail":"Project savings minus software costs"},{"label":"Present Business Case","detail":"One-page ROI summary for CFO approval"}]' color="emerald" />
...
<CostBreakdown title="Annual Procurement Waste Breakdown ($1.5M Spend)" items='[{"label":"Emergency Order Premiums","percentage":33},{"label":"Single-Source Overpayment","percentage":33},{"label":"Manual Labor Waste","percentage":14},{"label":"Wrong-Part Incidents","percentage":11},{"label":"Maverick Spend Premium","percentage":9}]' totalLabel="Total identified waste: $304,530/year" />
