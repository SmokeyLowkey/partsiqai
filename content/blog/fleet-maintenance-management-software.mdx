...
<MetricsDashboard title="Fleet Maintenance Software ROI (75-Unit Fleet)" metrics={[{value: "$547K", label: "Downtime Reduction", change: "38% fewer unplanned failures"}, {value: "$189K", label: "Parts Cost Savings", change: "28% through better sourcing"}, {value: "$134K", label: "Labor Efficiency", change: "22% less admin time"}, {value: "4-6 mo", label: "Payback Period", change: "10-20x annual ROI"}]} />
...
<TimelineDiagram title="Phased Fleet CMMS Implementation" events={[{label: "Asset Register + PM Schedules", detail: "Load all assets with active PM schedules", time: "Weeks 1-4"}, {label: "Work Orders + Labor Tracking", detail: "Transition all maintenance to digital work orders", time: "Weeks 5-8"}, {label: "Parts Inventory Baseline", detail: "Physical count and top-200 parts tracking", time: "Weeks 9-12"}, {label: "Telematics + Automation", detail: "Live meter data and automated reorder triggers", time: "Weeks 13-20"}, {label: "Optimization + Expansion", detail: "Data-driven fleet health and multi-site rollout", time: "Months 6-12"}]} color="emerald" />
