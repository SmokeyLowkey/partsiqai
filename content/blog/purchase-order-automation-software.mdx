...
<ComparisonDiagram title="Manual vs. Automated Purchase Orders" beforeTitle="Manual PO Processing" afterTitle="Automated PO Processing" before='[{"label":"$506 cost per PO","detail":"Labor, errors, and overhead"},{"label":"38% error rate","detail":"Transcription mistakes compound"},{"label":"4.1 day cycle time","detail":"From requisition to supplier"},{"label":"No real-time visibility","detail":"Status buried in email threads"}]' after='[{"label":"$35 cost per PO","detail":"93% reduction in processing cost"},{"label":"3.5% error rate","detail":"91% fewer errors"},{"label":"3.8 hour cycle time","detail":"88% faster end-to-end"},{"label":"Live status dashboard","detail":"Everyone sees PO status instantly"}]' />
...
<TimelineDiagram title="PO Automation Implementation Roadmap" events='[{"label":"Foundation","detail":"Catalog cleanup, approval mapping, supplier setup","time":"Weeks 1-3"},{"label":"Pilot","detail":"Single department rollout and validation","time":"Weeks 4-6"},{"label":"Scale","detail":"Full organization rollout and optimization","time":"Weeks 7-12"},{"label":"Advanced Features","detail":"Predictive reordering and spend analytics","time":"Month 4+"}]' color="emerald" />
