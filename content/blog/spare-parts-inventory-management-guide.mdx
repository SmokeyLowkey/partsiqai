...
<Callout type="tip" title="The strategic overview">
This guide focuses on spare parts specifically. For the broader parts inventory management playbook including procurement workflows, supplier networks, and KPIs, see our [Parts Inventory Management Complete Guide](/blog/parts-inventory-management-complete-guide). For OEM vs aftermarket decisions on spare parts, see our [OEM vs Aftermarket Decision Framework](/blog/oem-vs-aftermarket-parts-decision-framework).
</Callout>
...
<ComparisonDiagram title="Spare Parts vs. Regular Inventory" beforeTitle="Regular Inventory" afterTitle="Spare Parts Inventory" before='[{"label":"Predictable demand","detail":"Smooth, forecastable consumption"},{"label":"Low SKU variety","detail":"Hundreds to low thousands"},{"label":"Moderate stockout cost","detail":"Reorder and wait"},{"label":"Standard forecasting works","detail":"Moving averages are reliable"}]' after='[{"label":"Intermittent, lumpy demand","detail":"Months of zero, then sudden spikes"},{"label":"5,000+ unique part numbers","detail":"Many used fewer than 5 times/year"},{"label":"Extreme stockout cost","detail":"$500-$5,000/hour equipment downtime"},{"label":"Specialized methods required","detail":"Croston’s method and AI forecasting"}]' />
...
<ArchitectureDiagram title="AI-Powered Spare Parts Management" center='{"label":"AI Engine","detail":"Automates inventory math"}' nodes='[{"label":"PM Schedule Integration","detail":"Predict parts from maintenance plans"},{"label":"Dynamic Reorder Points","detail":"Auto-adjust min/max by season"},{"label":"Cross-Reference Database","detail":"Map OEM to aftermarket alternatives"},{"label":"Natural Language Search","detail":"Find parts by description, not number"}]' />
