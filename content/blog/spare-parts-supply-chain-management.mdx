...
<ComparisonDiagram title="Regular vs. Spare Parts Supply Chain" beforeTitle="Regular Supply Chain" afterTitle="Spare Parts Supply Chain" before='[{"label":"Smooth, predictable demand","detail":"Standard forecasting models work"},{"label":"Hundreds of SKUs","detail":"Manageable catalog size"},{"label":"Few strategic suppliers","detail":"Consolidated vendor relationships"},{"label":"One SKU = one product","detail":"Simple identification"}]' after='[{"label":"Intermittent, lumpy demand","detail":"Specialized forecasting required"},{"label":"Tens of thousands of SKUs","detail":"Heavy long-tail distribution"},{"label":"50-100+ specialized vendors","detail":"Fragmented supplier base"},{"label":"One part = many numbers","detail":"Cross-reference complexity"}]' />
...
<ArchitectureDiagram title="Spare Parts Supply Chain Tech Stack" center='{"label":"Parts Intelligence Platform","detail":"Purpose-built for spare parts"}' nodes='[{"label":"Intelligent Inventory","detail":"Criticality-based stocking with intermittent demand forecasting"},{"label":"Procurement Automation","detail":"Multi-supplier RFQ and quote comparison"},{"label":"Cross-Reference Engine","detail":"OEM, aftermarket, and supersession mapping"},{"label":"Analytics & Tracking","detail":"Demand patterns, supplier performance, inventory health"}]' />
