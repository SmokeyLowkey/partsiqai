...
<TimelineDiagram title="Evolution of Parts Catalogs" events={[{label: "Paper Catalogs", detail: "Heavy binders, annual updates, manual browsing", time: "Pre-2000s"}, {label: "PDF Catalogs", detail: "Digital files, Ctrl+F search, still siloed by brand", time: "2000s-2010s"}, {label: "Searchable Databases", detail: "Structured queries, but exact part numbers required", time: "2010s"}, {label: "AI-Powered Catalogs", detail: "Natural language search, cross-referencing, integrated procurement", time: "Now"}]} color="emerald" />
...
<ComparisonDiagram title="Paper/PDF vs. Digital Parts Catalog" beforeTitle="Paper & PDF Catalogs" afterTitle="AI-Powered Digital Catalog" before={[{label: "5-15 min per lookup", detail: "Manual page-by-page browsing"}, {label: "No cross-referencing", detail: "Miss cheaper aftermarket options"}, {label: "Outdated on arrival", detail: "Superseded parts not reflected"}, {label: "No inventory integration", detail: "Separate system to check stock"}]} after={[{label: "Under 30 seconds", detail: "Natural language search across all brands"}, {label: "Automatic cross-references", detail: "OEM and aftermarket alternatives surfaced"}, {label: "Always current", detail: "Real-time updates for supersessions"}, {label: "Integrated stock & pricing", detail: "See availability and supplier quotes instantly"}]} />
