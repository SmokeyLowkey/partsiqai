...
<ArchitectureDiagram title="Unified Heavy Equipment Parts Catalog" center={{label: "AI Search Engine", detail: "Natural language across all brands"}} nodes={[{label: "CAT SIS Data", detail: "Full Caterpillar parts coverage"}, {label: "Deere Parts Portal", detail: "John Deere catalog integration"}, {label: "Komatsu CSS", detail: "Komatsu parts and diagrams"}, {label: "Aftermarket Database", detail: "Cross-references and alternatives"}, {label: "Supplier Network", detail: "Real-time pricing and availability"}]} />
...
<FlowChart title="Parts Catalog Organization Framework" steps={[{label: "Machine Model + System", detail: "Organize by brand, model, then engine/hydraulic/undercarriage"}, {label: "Criticality + Frequency Tags", detail: "A/B/C rating drives stocking priority"}, {label: "Cross-Reference Mapping", detail: "Link OEM, aftermarket, remanufactured, and superseded numbers"}, {label: "Serial Number Compatibility", detail: "Tag parts with valid serial ranges to prevent errors"}, {label: "Diagram Linking", detail: "Connect parts to interactive schematics"}]} color="emerald" />
