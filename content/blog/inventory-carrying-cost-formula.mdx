...
<Callout type="tip" title="Carrying cost is one of twelve KPIs">
The carrying cost ratio is one of the most important parts inventory KPIs, but it's not the only one. For the full dashboard — turnover, fill rate, stockout rate, perfect order rate, and more — see [12 Parts Inventory KPIs Every Operations Team Should Track](/blog/parts-inventory-kpis-to-track). For the strategic context, see our [Parts Inventory Management Complete Guide](/blog/parts-inventory-management-complete-guide).
</Callout>

<CostBreakdown title="The Five Components of Inventory Carrying Cost" items='[{"label":"Capital Costs (cost of money)","percentage":40},{"label":"Storage Costs (warehousing)","percentage":25},{"label":"Obsolescence & Depreciation","percentage":18},{"label":"Insurance Costs","percentage":10},{"label":"Shrinkage (theft, damage, errors)","percentage":7}]' totalLabel="Total: 20-35% of inventory value per year" />
...
<FlowChart title="How to Calculate Your Carrying Cost Rate" steps='[{"label":"Determine Average Inventory Value","detail":"Average of 12 month-end values, not a single snapshot"},{"label":"Gather All Cost Components","detail":"Storage, capital, insurance, obsolescence, and shrinkage"},{"label":"Sum Total Carrying Expenses","detail":"Add all five cost categories together"},{"label":"Apply the Formula","detail":"(Total Expenses / Average Inventory Value) x 100 = Your Rate"}]' color="emerald" />
