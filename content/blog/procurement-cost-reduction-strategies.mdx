...
Track **price variance across locations** for identical SKUs (target: <5%), **percentage of spend under master agreements** (target: 50%+), and **average discount tier achieved** vs. individual location volumes.
...
Track **emergency order rate** (target: <5% of total orders), **average premium paid on expedited orders**, **stockout frequency** for critical parts, and **forecast accuracy** for recurring items.
...
Track **processing cost per PO** (target: <$15), **cycle time from requisition to PO** (target: <24 hours for standard orders), **percentage of POs auto-generated** (target: 40%+ for recurring items), and **team hours redirected to strategic activities**.
