...
<ComparisonDiagram title="CMMS vs EAM vs Procurement at a Glance" beforeTitle="What Each Does Best" afterTitle="Where Each Falls Short" before='[{"label":"CMMS: Maintenance execution","detail":"Work orders, PM scheduling, equipment history"},{"label":"EAM: Asset lifecycle","detail":"Capital planning, compliance, depreciation"},{"label":"Procurement: Buying efficiency","detail":"RFQs, supplier management, spend analytics"}]' after='[{"label":"CMMS: No real procurement","detail":"Basic PO form, no supplier comparison"},{"label":"EAM: Complex and costly","detail":"60%+ underutilized after 2 years"},{"label":"Procurement: No parts intelligence","detail":"Treats hydraulic pumps like office supplies"}]' />
...
<ArchitectureDiagram title="The Ideal Maintenance Technology Stack" center='{"label":"Parts Intelligence","detail":"AI-powered sourcing and procurement"}' nodes='[{"label":"CMMS / EAM","detail":"Maintenance scheduling and work orders"},{"label":"Supplier Network","detail":"Multi-vendor quoting and management"},{"label":"Inventory System","detail":"Multi-location stock visibility"},{"label":"ERP / Accounting","detail":"Financial tracking and cost allocation"}]' />
