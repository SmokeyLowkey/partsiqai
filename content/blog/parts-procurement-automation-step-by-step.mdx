...
<FlowChart title="The 6 Stages of Automated Parts Procurement" steps={[{label: "Need Detection", detail: "Automatic triggers from reorder points and maintenance schedules"}, {label: "Part Identification", detail: "AI-powered search with cross-referencing and compatibility checks"}, {label: "Supplier Selection", detail: "Rules-based routing with performance scoring"}, {label: "RFQ Distribution", detail: "Simultaneous multi-supplier quoting with auto follow-up"}, {label: "Quote Comparison", detail: "AI extracts and normalizes quotes for side-by-side review"}, {label: "PO Generation", detail: "One-click approval with automatic supplier notification"}]} color="emerald" />
...
<TimelineDiagram title="Procurement Automation Implementation Phases" events={[{label: "Automated RFQs", detail: "Send to multiple suppliers simultaneously", time: "Week 1-2"}, {label: "Quote Comparison", detail: "AI-powered extraction and normalization", time: "Week 2-4"}, {label: "Reorder Automation", detail: "Connect inventory to procurement triggers", time: "Month 2"}, {label: "Full-Cycle Automation", detail: "End-to-end with human approval oversight", time: "Month 3+"}]} color="emerald" />
