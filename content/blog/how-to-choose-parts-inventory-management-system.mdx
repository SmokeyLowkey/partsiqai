...
<FlowChart title="5-Step Decision Framework for Parts Inventory Software" steps='[{"label":"Define Requirements","detail":"Document fleet size, SKU count, locations, and users"},{"label":"Evaluate Must-Have Features","detail":"Search, tracking, reorder alerts, and reporting"},{"label":"AI vs Traditional","detail":"Determine if AI search justifies the investment"},{"label":"Assess Supplier Integration","detail":"Evaluate procurement connectivity and supplier network"},{"label":"Calculate Total Cost of Ownership","detail":"Implementation, training, ongoing costs, and ROI"}]' color="emerald" />
...
<MetricsDashboard title="Expected ROI from a Well-Chosen Parts Management System" metrics='[{"value":"$500-$2,000","label":"Saved Per Avoided Stockout","change":"↓ emergency orders"},{"value":"15-25%","label":"Excess Inventory Reduction","change":"↑ from demand forecasting"},{"value":"2-4 hrs","label":"Saved Per Procurement Cycle","change":"↑ from automation"},{"value":"40-60%","label":"Fewer Wrong-Part Orders","change":"↓ from AI cross-referencing"}]' />
