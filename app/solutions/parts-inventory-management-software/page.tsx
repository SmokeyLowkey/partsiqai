...
export const metadata: Metadata = {
  title: "Parts Inventory Management Software — AI-Powered Platform | PartsIQ",
  description:
    "All-in-one parts inventory management software with AI search, voice agent automation, quote management, and order tracking. Reduce sourcing time from 4 hours to 15 minutes.",
  keywords: [
